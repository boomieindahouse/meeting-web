<template>
  <section class="bg-primarybg text-white py-10 sm:py-10">
    <div
      class="container mx-auto flex flex-col-reverse sm:flex-row items-center"
    >
      <!-- ส่วนข้อความ -->
      ...
      <div class="w-full sm:w-1/2 mb-8 sm:mb-0">
        <img
          ...
          alt="Hero Image"
          class="w-full max-w-sm sm:max-w-full mx-auto"
        />
      </div>
    </div>
  </section>

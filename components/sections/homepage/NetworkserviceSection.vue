    ...
    >
      ...
      <div class="w-full text-center lg:text-center">
        ...
        <p class="sm:p-res mb-8 text-lg sm:text-xl">
            รับดูแลและออกแบบระบบเน็ตเวิร์คให้คำปรีกษาการเชื่อมต่อระบบเน็ตเวิร์ค ให้ใช้งานได้เสถียร และครอบคลุมทั้งสำนักงานตลอดจนการเดินสายแลน <br>เดินระบบกล้องวงจรปิด โดยบุคลากรที่เชี่ยวชาญด้านเทคนิคแก้ไขปัญหา ได้อย่างตรงจุด รับประกันงานติดตั้ง 1 ปีเต็ม
        </p>
        <div
      ...
      <div class="w-full mt-2">
        <Swiper :modules="modules" v-bind="swiperConfig" class="w-full h-full">
          <SwiperSlide
            v-for="(image, index) in networkProjectImages"
            :key="index"
